...
export interface MaterialServerService {
  getMaterials: (teacherId: string) => Promise<any[]>
  getMaterialById: (id: string) => Promise<any>
  getMaterialsByClass: (classId: string) => Promise<any[]>
  createMaterial: (data: MaterialCreateInput) => Promise<any>
  updateMaterial: (data: MaterialUpdateInput) => Promise<any>
  deleteMaterial: (id: string, teacherId: string) => Promise<any>
}

export const materialServerService: MaterialServerService = {
